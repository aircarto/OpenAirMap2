export function loadSensorCommunity() {
    console.log(
        '%cSensor.Community',
    ...
    $.ajax({
        ...
        .done(function (data) {
            ...
            var PACA = [
                10383, 11396, 30225, 54593, 61673, 65706, 67671, 69087, 69315,
                69349, 73276, 77775, 79683,
            ];

            // var filter_sensors = data.filter((e) => sensors.includes(e.sensor.sensor_type.name)  &&  PACA.includes(e.sensor.id));
            var filter_sensors = data.filter((e) =>
                sensors.includes(e.sensor.sensor_type.name)
            );
            ...
            $.each(filter_sensors, function (key, item) {
                ...
                var sensorCommunityPopup =
                    '<img src="img/LogoSensorCommunity.png" alt="" class="card-img-top">' +
                    '<div id="gauges">' +
                    ...
                    '<br>Dernière mesure effectuée :' +
                    timeDateCounter(item.timestamp) +
                    '<br>' +
                    '<br><button class="btn btn-outline-primary disabled" style="margin-right:5px;">Sensor.Community-' +
                    item.sensor.id +
                    '</button>' +
                    '<button class="btn btn-primary" onclick="OpenSidePanel(\'Sensor.Community-' +
                    item.sensor.id +
                ...
                switch (compoundUpper) {
                    case 'PM1':
                        filtered = item['sensordatavalues'].filter(
                            (e) => e.value_type == 'P0'
                        );
                ...
                if (!sensorsList.includes(item['sensor']['id'])) {
                    ...
                    var icon_param = {
                        iconUrl:
                            'img/SensorCommunity/SensorCommunity_default.png',
                    ...
                    if (
                        value_compound >= 0 &&
                        value_compound < 10 &&
                        (compoundUpper == 'PM1' || compoundUpper == 'PM25')
                    ) {
                        icon_param.iconUrl =
                            'img/SensorCommunity/SensorCommunity_bon.png';
                    }
                    //MOYEN
                    if (
                        value_compound >= 10 &&
                        ...
                        icon_param.iconUrl =
                            'img/SensorCommunity/SensorCommunity_moyen.png';
                    }
                    //DEGRADE
                    if (
                        value_compound >= 20 &&
                        ...
                        icon_param.iconUrl =
                            'img/SensorCommunity/SensorCommunity_degrade.png';
                    }
                    //MAUVAIS
                    if (
                        value_compound >= 25 &&
                        ...
                        icon_param.iconUrl =
                            'img/SensorCommunity/SensorCommunity_mauvais.png';
                    }
                    //TRES MAUVAIS
                    if (
                        value_compound >= 50 &&
                        ...
                        icon_param.iconUrl =
                            'img/SensorCommunity/SensorCommunity_tresMauvais.png';
                    }
                    //extr MAUVAIS
                    if (
                        value_compound >= 75 &&
                        ...
                        icon_param.iconUrl =
                            'img/SensorCommunity/SensorCommunity_extMauvais.png';
                    }
                    ...
                    if (value_compound != undefined && value_compound != null) {
                        ...
                        if (!isMobile) {
                            L.marker(
                                ...
                                .bindTooltip(sensorCommunityTootip, {
                                    direction: 'center',
                                })
                                    ...
                                    setTimeout(function () {
                                        am5.ready(function () {
                                            ...
                                            axisRenderer1.grid.template.setAll({
                                                stroke: root1.interfaceColors.get(
                                                    'background'
                                                ),
                                                visible: false,
                                                strokeOpacity: 0.8,
                                            ...
                                            var bullet1 = axisDataItem1.set(
                                                'bullet',
                                                am5xy.AxisBullet.new(root1, {
                                                    sprite: clockHand1,
                                                })
                                            );

                                            xAxis1.createAxisRange(
                                                axisDataItem1
                                            );

                                            var label1 =
                                                chart1.radarContainer.children.push(
                                                    am5.Label.new(root1, {
                                                        fill: am5.color(
                                                            0xffffff
                                                        ),
                                            ...
                                            bullet1
                                                .get('sprite')
                                                .on('rotation', function () {
                                                    var value1 =
                                                        axisDataItem1.get(
                                                            'value'
                                                        );
                                                    var text1 = Math.round(
                                                        axisDataItem1.get(
                                                            'value'
                                                        )
                                                    ).toString();
                                                ...
                                                function (data) {
                                                    ...
                                                    axisRange1
                                                        ...
                                                        .setAll({
                                                            ...
                                                            radius: 15,
                                                            fontSize: '0.9em',
                                                            fill: root1.interfaceColors.get(
                                                                'background'
                                                            ),
                                                        });
                                                }
                                            ...
                                            axisRenderer2.grid.template.setAll({
                                                stroke: root2.interfaceColors.get(
                                                    'background'
                                                ),
                                                visible: false,
                                                strokeOpacity: 0.8,
                                            ...
                                            var bullet2 = axisDataItem2.set(
                                                'bullet',
                                                am5xy.AxisBullet.new(root2, {
                                                    sprite: clockHand2,
                                                })
                                            );

                                            xAxis2.createAxisRange(
                                                axisDataItem2
                                            );

                                            var label2 =
                                                chart2.radarContainer.children.push(
                                                    am5.Label.new(root2, {
                                                        fill: am5.color(
                                                            0xffffff
                                                        ),
                                                ...
                                                function (data) {
                                                    ...
                                                    axisRange2
                                                        ...
                                                        .setAll({
                                                            ...
                                                            radius: 15,
                                                            fontSize: '0.9em',
                                                            fill: root2.interfaceColors.get(
                                                                'background'
                                                            ),
                                                        });
                                                }
                                            ...
                                            axisRenderer3.grid.template.setAll({
                                                stroke: root3.interfaceColors.get(
                                                    'background'
                                                ),
                                                visible: false,
                                                strokeOpacity: 0.8,
                                            ...
                                            xAxis3.createAxisRange(
                                                axisDataItem3
                                            );

                                            var label3 =
                                                chart3.radarContainer.children.push(
                                                    am5.Label.new(root3, {
                                                        fill: am5.color(
                                                            0xffffff
                                                        ),
                                                ...
                                                function (data) {
                                                    ...
                                                    axisRange3
                                                        ...
                                                        .setAll({
                                                            ...
                                                            radius: 15,
                                                            fontSize: '0.9em',
                                                            fill: root3.interfaceColors.get(
                                                                'background'
                                                            ),
                                                        });
                                                }
