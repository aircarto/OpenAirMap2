...
var seuilsPm10 = {
    ...
    "tresMauvais": {"code":"tresMauvais", "color_hex":"#941f36","min": 101, "max": 150},
    "extrMauvais": {"code":"extrMauvais", "color_hex":"#89207d","min": 151, "max": 99999}
}

for (let key in seuilsPm10) {
                            let code = seuilsPm10[key].code
                            let min = seuilsPm10[key].min
                            let max = seuilsPm10[key].max
                            let value_rounded = Math.round(value[mesure_maj_pasDeTemps]);
